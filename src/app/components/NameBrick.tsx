...
const NameBrick = ({ name, bg, img, className = `` }: NameBrickProps) => {
       return <li className={`min-h-[121px] relative ${className}`}>
              <div className=" rounded overflow-hidden pointer-events-none absolute inset-0">
                     <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11,0 h32 a3,3 0 0 1 3,3 v5 a3,3 0 0 0 3,3 h2 a3,3 0 0 0 3,-3 v-5 a3,3 0 0 1 3,-3 h32 a3,3 0 0 1 3,3 v5 a3,3 0 0 0 3,3 h2 a3,3 0 0 1 3,3 L100,97 a3,3 0 0 1 -3,3 L3,100 a3,3 0 0 1 -3,-3 L0,14 a3,3 0 0 1 3,-3 h2 a3,3 0 0 0 3,-3 v-5 a3,3 0 0 1 3,-3 z" fill={bg} />
                     </svg>
                     <div className=" top-8 left-0 right-0 bottom-0 absolute " style={{ backgroundColor: bg }}>
                     </div>
              </div>
